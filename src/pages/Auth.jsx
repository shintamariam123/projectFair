        ...
        <div className="card shadow p-5">
          <div className='row align-items-center'>
            <div className="col-lg-6">
              <img className='w-100' src="https://www.rocketdollar.com/hubfs/60-40_blog-1x2.png" alt="" />
            </div>
            <div className="col-lg-6">
                ...
                </FloatingLabel>
                {
                  insideRegister ?
                    <div className='mt-3'>
                      ...
                      <p className='mt-2'>Already have an account? Click here to <Link className='text-info' to={'/login'}>Login</Link></p>
                    </div>
                    :
                    <div className='mt-3'>

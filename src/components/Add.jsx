...
function Add() {
  ...
  const [imageFileSatus, setImageFileStatus] = useState(false)
  ...
  const handleUploadProject = async () => {
    //no need to use prevent default bz form is not used
    ...
    if (!title || !language || !overview || !github || !website || !projectImage) {
      ...
      //to add data in reqbody use append:blob means media file
          ...
          <div className='row'>
            <div className="col-lg-4">
              <label>
                ...
                <img className='img-fluid' style={{ height: '200px' }} src={preview} alt="" />
              </label>
              {!imageFileSatus &&

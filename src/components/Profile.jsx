...
:
<img width={'200px'} height={'200px'} src={preview?preview:`${SERVER_URL}/uploads/${existingImg}`} alt="" className='rounded-circle' />
}         </label>
         <div className='mb-2'>
         ...
         <div className='d-grid'>
          <button onClick={handleUserProfile} className='btn btn-warning'>UpdateProfile</button>
         </div>
        </div>
      </Collapse>
